...
app.use(convert(routerCache(app, {
  'GET /mes': {
    ...
    passthrough: function* passthrough(_cache) {
      if (_cache === null) {
        // _cache = MemoryCache.set('mes', fs.createReadStream(__dirname + '/public/index.html'))
        // console.log(MemoryCache.get('index'))
        MemoryCache.set('mes', '123')
        console.log(MemoryCache.get('mes'))
        return {
          shouldCache: true,
          shouldPass: true
        }
